...
VALID_SPORTS = {"football", "nba", "tennis", "ufc"}
...
def free_limit_message(language="ru"):
    if language == "en":
        return (
            "🔒 You have reached today's free analysis limit.\n\n"
            "Activate FLUX AI PRO and get:\n"
            "✅ Unlimited sports analysis\n"
            "✅ Football, NBA, Tennis and UFC analysis\n"
            "✅ Extended statistics\n"
    ...
    return (
        "🔒 Вы достигли дневного лимита бесплатных анализов.\n\n"
        "Оформите FLUX AI PRO и получите:\n"
        "✅ Безлимитный анализ спорта\n"
        "✅ Анализ футбола, NBA, тенниса и UFC\n"
